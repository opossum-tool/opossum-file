...
class OwaspFaker(Faker):
    ...
    def __init__(
        ...
        **config: Any,
        ...
        self.package_model = self.owasp_provider.package_model
        self.package_models = self.owasp_provider.package_models
        self.vulnerability_model = self.owasp_provider.vulnerability_model
